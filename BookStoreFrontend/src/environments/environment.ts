...
export const environment = {
  ...
  BASE_URL: 'https://htqlbe-production.up.railway.app',
  BookUrl: 'https://htqlbe-production.up.railway.app',
  ...
  adminUrl: 'https://htqlbe-production.up.railway.app/',
